	...
	<div id="wrapper">
		...
		<nav id="nav">
			<ul class="links">
				...
				<li><a href="index.php#kandidat">Daftar Kandidat</a></li>
				<li class="active"><a href="login.php">Login</a></li>
			</ul>
			<ul class="icons">
				<li><a href="https://twitter.com/manmodel1manado" class="icon brands fa-twitter"><span class="label">Twitter</span></a></li>
				<li><a href="https://www.facebook.com/manmodelmanado" class="icon brands fa-facebook-f"><span class="label">Facebook</span></a></li>
				<li><a href="https://www.instagram.com/manmodel1manado/" class="icon brands fa-instagram"><span class="label">Instagram</span></a></li>
				<li><a href="https://manmodelmanado.sch.id" class="fa fa-globe" style="font-size: 13px"></a></li>
			</ul>
		</nav>
		...
		<body>
			...
			<div id="main" style="size: initial">
