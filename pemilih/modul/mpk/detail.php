...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="?u=mpk"><i class="fa fa-laptop"></i> Kandidat</a></li>
								...
								<tr>
									...
									<td>
										...
										if ($r['foto'] != '') {
											...
											echo "<img src=\"../images/calonmpk/0.jpg\">";
										}
										?>
								</tr>
								<tr>
									<td colspan=2>
										<a href="?u=mpk" class="btn btn-large btn-danger"><i class="fa fa-times"></i> List</a></td>
								</tr>
							</tbody>
						</table>
						</form>
