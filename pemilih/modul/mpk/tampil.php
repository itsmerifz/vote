...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="?u=mpk"><i class="fa fa-graduation-cap"></i> Kandidat</a></li>
      ...
      <div class="col-xs-12">
        ...
        ';
              ...
              while ($r = mysqli_fetch_assoc($query)) {
                echo "<tr>";
                echo "<td>$no</td>";
                echo "<td><a href='?u=mpk&s=detail&idp=" . $r['idkandidat'] . "'><img src='../images/calonmpk/" . $r['foto'] . "' height='100px'/></a></td>";
                echo "<td>" . $r['nama'] . "</td>";
