...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="?u=osis"><i class="fa fa-laptop"></i> Kandidat</a></li>
								...
								<tr>
									...
									<td>
										...
										if ($r['foto'] != '') {
											...
											echo "<img src=\"../images/calonosis/0.jpg\">";
										}
										?>
								</tr>
								<tr>
									<td colspan=2>
										<a href="?u=osis" class="btn btn-large btn-danger"><i class="fa fa-times"></i> List</a></td>
								</tr>
							</tbody>
						</table>
						</form>
