					...
					<form action="loginTo.php" method="POST">
						<p>
							<center><label style="font-size: 20px">Username</label>
								<input type="text" style="width: 50%" class="login__input name" name="user" autofocus required></center>
						</p>
						<p>
							<center><label style="font-size: 20px">Password</label>
								<input type="password" style="width: 50%" class="login__input pass" name="pass" autofocus required></center>
						</p>
