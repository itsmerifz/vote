...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="?u=calonosis"><i class="fa fa-laptop"></i> Kandidat OSIS</a></li>
			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">Form Edit Kandidat OSIS</h3>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
						<?php
						...
						?>
						<!--Mulai buat form-->
						<form action="?u=calonosis&s=update" method="post" enctype="multipart/form-data">
							<table id="pilkasis1" class="table table-bordered table-hover table-striped">
								<tbody>
									<tr>
										<td width=150>Nama Pengguna*</td>
										<td><input type="text" name="username" placeholder="Username" size="25px" maxlength="100px" value="<?php echo $r['username']; ?>" required /></td>
									</tr>
									<tr>
										<td>Sandi</td>
									...
									<tr>
										<td>Nama Calon*</td>
										<td><input type="text" name="nama" placeholder="Nama" size="50px" maxlength="100px" value="<?php echo $r['nama']; ?>" required /></td>
									</tr>
									<tr>
										<td>No Kandidat</td>
									...
									<tr>
										...
										<td>
											<?php
											if ($r['foto'] != '') {
												echo "<img src=\"../images/calonosis/$r[foto]\" height=150 />";
											} else {
												echo "<img src=\"../images/calonosis/admin.jpg\">";
											}
											?>
									</tr>
									<tr>
