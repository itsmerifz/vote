			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">Detail Kandidat OSIS</h3>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
						<?php
					...
					<tr>
									...
									<td>
										<?php
										if ($r['foto'] != '') {
											echo "<img src=\"../images/calonosis/$r[foto]\" width=150 />";
										} else {
								...
								<tr>
									<td colspan=2>
										<a href="?u=calonosis&s=edit&nip=<?php echo $id; ?>" class="btn btn-large btn-primary"><i class="fa fa-times"></i> Edit</a>
