			...
			<div class="col-xs-12">
				<div class="box">
					...
					<div class="box-body">
						...
						?>
						<!--Mulai buat form-->
						<form action="?u=admin&s=update" method="post" enctype="multipart/form-data">
							<table id="pilkasis1" class="table table-bordered table-hover table-striped">
								<tbody>
									...
									<tr>
										<td>Email</td>
										<td><input type="email" name="email" placeholder="Email" size="50px" maxlength="50px" value="<?php echo $r['email']; ?>" /></td>
									</tr>
									<tr>
										<td>Hak Akses</td>
										<td>
									...
									<tr>
										<td colspan=3>
											...
											<a href="?u=admin" class="btn btn-large btn-danger"><i class="fa fa-times"></i> List</a></td>
									</tr>
								</tbody>
							</table>
						</form>
