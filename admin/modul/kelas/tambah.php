    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="box">
          ...
          <div class="box-body">
            <!--Mulai buat form-->
            <form action="?u=kelas&s=simpan" method="post" enctype="multipart/form-data">
              <table id="pilkasis1" class="table table-bordered table-hover table-striped">
                <tbody>
                  <tr>
                    <td width=174>Nama Kelas*</td>
                    <td><input type="text" name="kelas" placeholder="Kelas" size="7px" maxlength="30px" required /></td>
                  </tr>
                  <tr>
