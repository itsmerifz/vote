      ...
      <footer class="main-footer">
        ...
        <strong><?php echo "&copy; 2019-".date("Y")." Made by luv "; ?> <a href="http://instagram.com/itsme_rifz" target="_blank">Muhammad Arief</a>.
      </footer>
...
<script src="plugins/input-mask/jquery.inputmask.extensions.js"></script>
	...
	<script>
	  $(function(){
		$('#votingm21m1').DataTable();
		$('#votingm21m2').DataTable({
		  "paging": true,
		  "lengthChange": true,
		  "searching": true,
		  "ordering": true,
